...
var _scrollPage = require("./modules/scroll-page");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _scrollPage.scrollPage)();
    (0, _swiper.initSlider)();
    (0, _video.initVideos)();
...
},{"./modules/form-validate/form":3,"./modules/scroll-page":9,"./modules/swiper":10,"./modules/tabs/init-tabs":11,"./modules/video":13,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
